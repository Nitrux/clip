...
DEBIAN_FRONTEND=noninteractive apt -qq -yy install --no-install-recommends libkf5config-dev libkf5coreaddons-dev libkf5i18n-dev libkf5kio-dev libkf5notifications-dev libkf5service-dev libqt5svg5-dev libmauikitfilebrowsing-dev libmpv-dev qtdeclarative5-dev qtquickcontrols2-5-dev qtmultimedia5-dev
